...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            The rectangle with the biggest area or `rect_1` if they have
            the same area.
    ...
    def square(cls, size=0):
        ...
        Returns:
            An instance of Rectangle with width == height == size.
        """
    ...
    def __del__(self):
        """Logs goodbye message when instance is deleted."""
        print("Bye rectangle...")
        type(self).number_of_instances -= 1
